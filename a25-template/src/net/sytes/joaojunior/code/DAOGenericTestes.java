...
public class DAOGenericTestes {
	...
	public static void salvarAluno() throws IOException {
		...
		new ExtraCurricularDao(null).salve(atv1);
		//manager.persist(atv2);
		new ExtraCurricularDao(null).salve(atv2);
		//manager.persist(s);	
		new SedeDao(null).salve(s);
		//manager.persist(t1);
		new TelefoneDao(null).salve(t1);
		//manager.persist(t2);
		new TelefoneDao(null).salve(t2);
		//manager.persist(e);
		new EnderecoDao(null).salve(e);
		//manager.persist(a);		
		new AlunoDao().salve(a);
